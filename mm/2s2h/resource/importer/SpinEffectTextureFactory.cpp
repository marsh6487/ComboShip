...
const NativeTextureProfile* GetNativeProfile(std::string_view path) {
    ...
    static constexpr NativeTextureProfile profiles[] = {
        // MM's native spin, torch/decorative flame and elemental arrow materials.
        // Dimensions/formats agree in both N64_US and GC_US extraction XML.
        { "objects/gameplay_keep/gSpinAttack1Tex", 64, 32, Grayscale8bpp, true },
        { "objects/gameplay_keep/gSpinAttack2Tex", 64, 32, Grayscale8bpp, true },
        { "objects/gameplay_keep/gSpinAttackCharging1Tex", 32, 32, Grayscale8bpp, true },
        { "objects/gameplay_keep/gSpinAttackCharging2Tex", 32, 32, Grayscale8bpp, true },
        { "objects/gameplay_keep/gEffFireTex", 32, 64, Grayscale8bpp },
        { "objects/gameplay_keep/gEffFireMaskTex", 32, 128, Grayscale4bpp },
        { "overlays/ovl_Arrow_Fire/gFireArrowTex", 32, 64, Grayscale8bpp },
        { "overlays/ovl_Arrow_Fire/gFireArrowMaskTex", 32, 64, Grayscale8bpp },
        { "overlays/ovl_Arrow_Ice/gIceArrowTex", 32, 64, Grayscale8bpp },
        { "overlays/ovl_Arrow_Ice/gIceArrowMaskTex", 32, 64, Grayscale8bpp },
        { "overlays/ovl_Arrow_Light/gLightArrowTex", 32, 64, Grayscale8bpp },
        { "overlays/ovl_Arrow_Light/gLightArrowMaskTex", 32, 64, Grayscale8bpp },
        // OoT companion resources use their own names in MM's resource manager.
        // Keep the donor's exact profiles for those and the shared private packs.
