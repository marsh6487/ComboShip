    ...
    switch (item) {
        case RG_MAGIC_SINGLE:
            gSaveContext.ship.quest.data.randomizer.comboNativeMagicLevel =
                std::max<uint8_t>(gSaveContext.ship.quest.data.randomizer.comboNativeMagicLevel, 1);
            gSaveContext.isMagicAcquired = true;
            gSaveContext.magicFillTarget = MAGIC_NORMAL_METER;
            Magic_Fill(play);
            break;
        case RG_MAGIC_DOUBLE:
            gSaveContext.ship.quest.data.randomizer.comboNativeMagicLevel = 2;
        ...
        case RG_MAGIC_STAT_UPGRADE: {
            ...
            uint8_t fillCap = MagicStatCapacity(lvl, required, adjustable,
                                                gSaveContext.ship.quest.data.randomizer.comboNativeMagicLevel);
