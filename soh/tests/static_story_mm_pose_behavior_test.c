...
/* Anju rendering has its own viewer fixture. These paths must stay unused by
 * the Skull Kid tracking and Lulu facing checks in this focused fixture. */
...
static void EnViewer_StaticAnjuPostLimbDraw(PlayState* play, s32 limb, Gfx** displayList, Vec3s* rot, void* actor) {
    REQUIRE(false);
}
