...
int main(int argc, char** argv) {
    ...
    checkOther("Alias", material, true, true, material->Instructions.data());
    ...
    checkOther("Empty", Resource<Fast::DisplayList>("alt/empty", Fast::ResourceType::DisplayList), true, true);
